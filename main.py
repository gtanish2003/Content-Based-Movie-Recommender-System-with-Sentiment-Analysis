...
filename = 'C:\\Users\\Ashish Gupta\\OneDrive\\Desktop\\Summer Training\\.ipynb_checkpoints\\nlp_model.pkl'
clf = pickle.load(open(filename, 'rb'))
vectorizer = pickle.load(open('C:\\Users\\Ashish Gupta\\OneDrive\\Desktop\\Summer Training\\.ipynb_checkpoints\\tranform.pkl','rb'))
...
def get_suggestions():
    data = pd.read_csv('C:\\Users\\Ashish Gupta\\OneDrive\\Desktop\\Summer Training\\.ipynb_checkpoints\\final_data.csv')
